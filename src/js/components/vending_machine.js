class Vendingmachine {
    ...
    bindEvents() {
        /*
         * 1. 입금 버튼 기능
         * 입금액을 입력하고 입금 버튼을 누르면 소지금 == 소지금 - 입금액, 잔액 == 기존 잔액 + 입금액
         * 입금액이 소지금 보다 많다면 실행을 중단하고 "소지금이 부족합니다." 라고 쓰인 경고창을 띄움
         * 입금액 인풋창은 초기화됨
         * */
        ...
        * 아이템 가격보다 잔액이 적다면 "잔액이 부족합니다. 돈을 입금해주세요" 경고창이 나타남
        * 아이템이 획득가능 창에 등록
        * 아이템 버튼의 data-count은 -1 됨
        * 만약 data-count 값이 0 이라면 부모 li에 sold-out 클래스를 붙여줌
       */
